<template>    
    <div class="p-3">
        ...
        <pre v-if="!loading" class="overflow-x-auto overflow-y-hidden border-t-2 border-fuchsia-600 pt-2">{{ document }}</pre>
...
route.params.doc_id = `_design/${route.params.doc_id}`
